...
const AssignmentTable = ({ activeTab }) => {
  ...
  useEffect(() => {
    ...
    const fetchAssignments = async () => {
      try {
        const response = await fetch("http://your-api-url/api/assignments"); // Update with your API endpoint
  ...
  const handleFormSubmit = () => {
    if (code && file) {
      // Form submission logic goes here (e.g., uploading the code and file)
      console.log("Submitting code and file for assignment ID:", submittedAssignment);
      console.log("Code:", code);
      console.log("File:", file);
      // Reset after submission
